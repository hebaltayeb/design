...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden mb-6">
            <div class="p-6 flex justify-between items-center bg-gradient-to-r from-[#ffd1dc] to-white">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        @if ($user->is_designer)
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-[#ffd1dc] text-gray-800">
                                                Designer
                                            </span>
                                        @endif
                                    </div>
