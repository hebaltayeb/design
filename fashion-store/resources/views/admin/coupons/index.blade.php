    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('admin.coupons.show', $coupon) }}" class="text-blue-600 hover:text-blue-900 mr-3">
            ...
            <div class="text-center py-4">
                ...
                <p class="text-gray-500">No coupons found. Create your first coupon!</p>
                <a href="{{ route('admin.coupons.create') }}" class="mt-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
