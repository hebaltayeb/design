                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="designer_id" name="designer_id">
                                            ...
                                            <option value="{{ $designer->id }}" {{ old('designer_id', $product->designer_id) == $designer->id ? 'selected' : '' }}>
                                                {{ $designer->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="approval_status" name="approval_status">
                                            ...
                                            <option value="canceled" {{ old('approval_status', $product->approval_status) == 'canceled' ? 'selected' : '' }}>Canceled</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="seo_description" name="seo_description" rows="2">{{ old('seo_description', $product->seo_description) }}</textarea>
                                    </div>
                                </div>
                            </div>
